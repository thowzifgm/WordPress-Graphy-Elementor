...
"use strict";
/*!*******************************************************!*\
  !*** ./wp-content/plugins/graphist-elementor/js/source/exp.js ***!
  \*******************************************************/
...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        const { ajaxURL, nonce } = mdpGraphistElementorUnity;
            ...
            $exportButton.addEventListener('click', (e) => {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status === 200) {
                        ...
                        // Download file
                        let fileName = 'graphist-elementor-settings.json'
                ...
                xhr.send(`action=export_settings_graphist_elementor&nonce=${nonce}`);
        ...
        function readFile( file ) {
            ...
            reader.onload = ( function( theFile ) {
                ...
                return function( e ) {
                    ...
                    xhr.send(`action=import_settings_graphist_elementor&nonce=${ nonce }&import=${ encodeURIComponent( JSON.stringify( json ) ) }`);
