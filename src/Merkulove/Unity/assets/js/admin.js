...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpGraphyElementor = window.mdpGraphyElementorUnity;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpGraphyElementor.restBase }graphy-elementor/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_graphy_elementor',
                nonce: mdpGraphyElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpGraphyElementor.ajaxURL, data, function( response ) {
