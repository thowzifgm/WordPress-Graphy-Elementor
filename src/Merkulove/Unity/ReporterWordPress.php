...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'graphy-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'graphy-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'graphy-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'graphy-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'graphy-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'graphy-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'graphy-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'graphy-elementor' ),
			'language'              => esc_html__( 'Language', 'graphy-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'graphy-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'graphy-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'graphy-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'graphy-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'graphy-elementor' ) : esc_html__( 'No', 'graphy-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'graphy-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'graphy-elementor' ) : esc_html__( 'Inactive', 'graphy-elementor' )
		];
