...
final class PluginHelper {
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'graphy-elementor' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'graphy-elementor', false, Plugin::get_path() . '/languages/' );
