...
class multiline_bar_elementor extends Widget_Base {
    ...
    false
        ...
        wp_register_script(
            'mdp-graphy-multiline-bar-popup',
    ...
    public function get_name() {
        return 'mdp-graphy-multiline-bar';
    }
    ...
    public function get_title() {
        return esc_html__( 'Multiline Bar Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'multiline', 'bar', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Multiline Bar Chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Multiline Bar Chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Multiple Vertical Bar Chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Multiple Vertical Bar Chart', 'graphy-elementor' ),
