...
class gauge_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Gauge Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'gauge', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Gauge Chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Gauge Chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'This pie chart uses total.', 'graphy-elementor' ),
                'default'               => esc_html__( 'This pie chart uses total.', 'graphy-elementor' ),
        ...
        $repeater->add_control(
            'label_family',
            [
                'label' => esc_html__( 'Labels font', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show labels results as a percentage', 'graphy-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'graphy-elementor' ),
                'label_off' => esc_html__( 'Hide', 'graphy-elementor' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'donut_options',
            [
                'label' => esc_html__( 'Donut settings', 'graphy-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'gauge_options',
            [
                'label' => esc_html__( 'Gauge settings', 'graphy-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'start_angle',
            [
                'label' => esc_html__( 'Start angle', 'graphy-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'total_angle',
            [
                'label' => esc_html__( 'Total', 'graphy-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
                'range' => [
                    '%' => [
    ...
    protected function render() {
        ...
        $speed_animation = !empty($settings['speed_animation']) ? $settings['speed_animation'] : 0;
        ...
        $script_popup = "<script>ready( () => { ".
            "window.GaugePopup( \"%s\", [%s], '%s', %s, %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s', %s ); ".
            "});</script>";
