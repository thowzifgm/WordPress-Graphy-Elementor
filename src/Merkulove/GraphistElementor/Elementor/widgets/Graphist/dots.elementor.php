...
class dots_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Dots Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'dots', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Dots chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Dots chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'This advanced example uses a line chart to draw a scatter diagram. The data object is created with a functional style random mechanism. ', 'graphy-elementor' ),
                'default'               => esc_html__( 'This advanced example uses a line chart to draw a scatter diagram. The data object is created with a functional style random mechanism. ', 'graphy-elementor' ),
