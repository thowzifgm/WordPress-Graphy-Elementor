...
class holes_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Holes Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'holes', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Holes chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Holes chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Sometimes you don\'t want your data looking so fragmented, even when it really is. That\'s why you can also configure Graphy to smooth over holes in your data.', 'graphy-elementor' ),
                'default'               => esc_html__( 'Sometimes you don\'t want your data looking so fragmented, even when it really is. That\'s why you can also configure Graphy to smooth over holes in your data.', 'graphy-elementor' ),
