...
class stacked_bar_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Stacked Bar Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'stacked', 'bar', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Stacked Bar Chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Stacked Bar Chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'You can also set your bar chart to stack the series bars on top of each other easily.', 'graphy-elementor' ),
                'default'               => esc_html__( 'You can also set your bar chart to stack the series bars on top of each other easily.', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'                  => Controls_Manager::TEXTAREA,
                'dynamic'               => ['active' => true],
                'description'           => esc_html__( 'Default shortcode [stacked_bar_chart]', 'graphy-elementor' ),
        ...
        $this->add_control(
            'number_lines',
            [
                'label' => esc_html__( 'Number of bars per series', 'graphy-elementor' ),
        ...
        $this->add_control(
            'value_list_item_1',
            [
                'label' => esc_html__( 'Bar chart value', 'graphy-elementor' ),
                'type' => Controls_Manager::REPEATER,
        ...
        $this->add_control(
            'info_text_1',
            [
                'label' => esc_html__( 'Helper text', 'graphy-elementor' ),
                'type' => Controls_Manager::RAW_HTML,
                'raw' => esc_html__( 'The number of bars in the chart must match.', 'graphy-elementor' ),
            ]
        );
