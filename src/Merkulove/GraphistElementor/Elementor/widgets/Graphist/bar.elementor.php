...
class bar_elementor extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Bar Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'bar', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'horizontal',
            [
                'label' => esc_html__( 'Horizontal Bars', 'graphy-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'On', 'graphy-elementor' ),
                'label_off' => esc_html__( 'Off', 'graphy-elementor' ),
                'return_value' => 'yes',
                'default' => 'no',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Bar chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Bar chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Sometime it\'s desired to have bar charts that show one bar per series distributed along the x-axis. If this option is enabled, you need to make sure that you pass a single series array to Graphy that contains the series values. In this example you can see T-shirt sales of a store categorized by size.', 'graphy-elementor' ),
                'default'               => esc_html__( 'Sometime it\'s desired to have bar charts that show one bar per series distributed along the x-axis. If this option is enabled, you need to make sure that you pass a single series array to Graphy that contains the series values. In this example you can see T-shirt sales of a store categorized by size.', 'graphy-elementor' ),
