...
class bipolar_line_elementor extends Widget_Base {
    ...
    public function get_name() {
        return 'mdp-graphy-bipolar-line';
    }
    ...
    public function get_title() {
        return esc_html__( 'Bipolar Line Chart', 'graphy-elementor' );
    }
    ...
    public function get_keywords() {
        return [ 'Merkulove', 'chart', 'bipolar', 'line', 'graphy', 'chartist' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'Bi-polar Line Chart', 'graphy-elementor' ),
                'default'               => esc_html__( 'Bi-polar Line Chart', 'graphy-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'               => ['active' => true],
                'placeholder'           => esc_html__( 'You can also only draw the area shapes of the line chart. Area shapes will always be constructed around their areaBase (that can be configured in the options) which also allows you to draw nice bi-polar areas.', 'graphy-elementor' ),
                'default'               => esc_html__( 'You can also only draw the area shapes of the line chart. Area shapes will always be constructed around their areaBase (that can be configured in the options) which also allows you to draw nice bi-polar areas.', 'graphy-elementor' ),
