window.Area = function ( uniqueId,
    ...
    function visibleArea (target) {
        ...
        if (targetPosition.bottom > windowPosition.top &&
            ...
            if( count === 0 ) {
                const area = new Chartist.Line( globalClass, {
                    labels: arrayLabels,
                    series: point
            }, {
                ...
                if( showAnimation === 'yes' ) {
                    ...
                    let seq = 0;
                    const delays = 80;
                    let durations = parseInt(speedAnimation);

                    // Once the chart is fully created we reset the sequence
                    area.on( 'created', function () { seq = 0; } );

                    // On each drawn element by Chartist we use the Chartist.Svg API to trigger SMIL animations
                    area.on( 'draw', function ( data ) {
                        seq++;
    ...
    const elementArea = document.querySelector(`.elementor-element-${ uniqueId }`);
